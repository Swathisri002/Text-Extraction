...
# Function to extract text from image using Tika
def extract_text_with_tika(image_path):
...
for image_file in image_files:
    ...
    # Extract general text from the image using Tika
    general_text = extract_text_with_tika(image_path)
    ...
    if general_text and general_text.strip():
        ...
        if contours:
            ...
            for i, contour in enumerate(contours):
                ...
                table_text = extract_text_with_tika(table_image_path)
